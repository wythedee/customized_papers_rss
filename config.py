PROMPT = "Please read the following abstract of a paper and evaluate if the research \
        could be adapted to or is related to the field of multimodal misinformation detection. \
